...
import { NearestFilter, WebGLRenderTarget as WebGLRenderTarget3 } from './three.module.js';

// src/materials/AdaptiveLuminanceMaterial.js
import { NoBlending, REVISION, ShaderMaterial, Uniform } from './three.module.js';
...
import { NoBlending as NoBlending2, ShaderMaterial as ShaderMaterial2, Uniform as Uniform2, Vector2 } from  './three.module.js';
...
import { NoBlending as NoBlending3, PerspectiveCamera, ShaderMaterial as ShaderMaterial3, Uniform as Uniform3, Vector2 as Vector22 } from './three.module.js';
...
import { BasicDepthPacking, NoBlending as NoBlending4, PerspectiveCamera as PerspectiveCamera2, ShaderMaterial as ShaderMaterial4, Uniform as Uniform4 } from './three.module.js';
...
import { NoBlending as NoBlending5, ShaderMaterial as ShaderMaterial5, Uniform as Uniform5, Vector4 } from './three.module.js';
...
import { NoBlending as NoBlending7, PerspectiveCamera as PerspectiveCamera3, RGBADepthPacking, ShaderMaterial as ShaderMaterial7, Uniform as Uniform7 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking2, NoBlending as NoBlending8, ShaderMaterial as ShaderMaterial8, Uniform as Uniform8, Vector2 as Vector23 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking3, NoBlending as NoBlending9, ShaderMaterial as ShaderMaterial9, Uniform as Uniform9, Vector2 as Vector24 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking5, NoBlending as NoBlending12, REVISION as REVISION3, ShaderMaterial as ShaderMaterial12, Uniform as Uniform12, Vector2 as Vector27 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking6, NoBlending as NoBlending13, PerspectiveCamera as PerspectiveCamera5, REVISION as REVISION4, ShaderMaterial as ShaderMaterial13, Uniform as Uniform13, Vector2 as Vector28 } from './three.module.js';
...
import { NoBlending as NoBlending14, ShaderMaterial as ShaderMaterial14, Uniform as Uniform14, Vector2 as Vector29 } from './three.module.js';
...
import { NoBlending as NoBlending16, REVISION as REVISION5, ShaderMaterial as ShaderMaterial16, Uniform as Uniform16 } from './three.module.js';
...
import { NoBlending as NoBlending17, ShaderMaterial as ShaderMaterial17, Uniform as Uniform17, UnsignedByteType as UnsignedByteType2 } from './three.module.js';
...
import { NoBlending as NoBlending18, ShaderMaterial as ShaderMaterial18, Uniform as Uniform18, Vector2 as Vector210 } from './three.module.js';
...
import { NoBlending as NoBlending19, ShaderMaterial as ShaderMaterial19, Uniform as Uniform19, Vector2 as Vector211 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking7, Matrix4, NoBlending as NoBlending20, PerspectiveCamera as PerspectiveCamera6, ShaderMaterial as ShaderMaterial20, Uniform as Uniform20, Vector2 as Vector212 } from './three.module.js';
...
import { Uniform as Uniform21, Vector2 as Vector213, Vector4 as Vector42 } from './three.module.js';
...
import { NoBlending as NoBlending21, ShaderMaterial as ShaderMaterial21, Uniform as Uniform22, Vector2 as Vector214 } from './three.module.js';
...
import { LinearFilter, sRGBEncoding as sRGBEncoding2, UnsignedByteType as UnsignedByteType3, WebGLRenderTarget as WebGLRenderTarget2 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking9, sRGBEncoding as sRGBEncoding3, UnsignedByteType as UnsignedByteType4, WebGLRenderTarget as WebGLRenderTarget4 } from './three.module.js';
...
import { Color as Color2, MeshDepthMaterial, NearestFilter as NearestFilter2, RGBADepthPacking as RGBADepthPacking2, WebGLRenderTarget as WebGLRenderTarget5 } from './three.module.js';

// src/core/Resolution.js
import { EventDispatcher, Vector2 as Vector215 } from './three.module.js';
var AUTO_SIZE = -1;
...
import { BasicDepthPacking as BasicDepthPacking10, FloatType, NearestFilter as NearestFilter3, WebGLRenderTarget as WebGLRenderTarget6 } from './three.module.js';
...
import { FloatType as FloatType3, RGBADepthPacking as RGBADepthPacking4 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking12, UnsignedByteType as UnsignedByteType6, sRGBEncoding as sRGBEncoding4 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding5, UnsignedByteType as UnsignedByteType7, WebGLRenderTarget as WebGLRenderTarget8 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding6, UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget9 } from './three.module.js';
...
import { UnsignedByteType as UnsignedByteType9, WebGLRenderTarget as WebGLRenderTarget10 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding7, UnsignedByteType as UnsignedByteType10, Vector2 as Vector216, WebGLRenderTarget as WebGLRenderTarget11 } from './three.module.js';
...
import { Color as Color3, MeshNormalMaterial, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget12 } from './three.module.js';
...
import { UnsignedByteType as UnsignedByteType11 } from './three.module.js';
...
import { LinearEncoding as LinearEncoding2 } from './three.module.js';
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform23 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding9, Uniform as Uniform24, WebGLRenderTarget as WebGLRenderTarget15 } from './three.module.js';

// src/effects/Effect.js
import { BasicDepthPacking as BasicDepthPacking13, EventDispatcher as EventDispatcher3, LinearEncoding as LinearEncoding3, Material as Material2, Texture as Texture2, WebGLRenderTarget as WebGLRenderTarget14 } from './three.module.js';
...
import { Uniform as Uniform25 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding10, Uniform as Uniform26 } from './three.module.js';
...
import { Uniform as Uniform28, Vector2 as Vector218 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking14, sRGBEncoding as sRGBEncoding11, Uniform as Uniform29, UnsignedByteType as UnsignedByteType13, WebGLRenderTarget as WebGLRenderTarget16 } from './three.module.js';
...
import { Uniform as Uniform30, Vector2 as Vector219 } from './three.module.js';
...
import { Uniform as Uniform31 } from './three.module.js';
...
import { NearestFilter as NearestFilter6, RepeatWrapping, RGBAFormat as RGBAFormat3, Uniform as Uniform32, Vector2 as Vector220 } from './three.module.js';
...
import { Uniform as Uniform34, Vector2 as Vector222 } from './three.module.js';
...
import { Uniform as Uniform35, Vector3 as Vector32 } from './three.module.js';
...
import { FloatType as FloatType4, HalfFloatType, Uniform as Uniform36 } from './three.module.js';
...
import { Color as Color6, RepeatWrapping as RepeatWrapping2, Uniform as Uniform38, UnsignedByteType as UnsignedByteType16, WebGLRenderTarget as WebGLRenderTarget18 } from './three.module.js';
...
import { Uniform as Uniform39, Vector2 as Vector223, Vector4 as Vector43 } from './three.module.js';
...
import { Uniform as Uniform40, Vector4 as Vector44 } from './three.module.js';
...
import { Uniform as Uniform41, Vector2 as Vector224 } from './three.module.js';
...
import { Uniform as Uniform42, Vector2 as Vector225, Vector3 as Vector35 } from './three.module.js';
...
import { Uniform as Uniform43, Vector3 as Vector36 } from './three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking18, Color as Color9, RepeatWrapping as RepeatWrapping3, RGBAFormat as RGBAFormat5, Uniform as Uniform45, WebGLRenderTarget as WebGLRenderTarget21 } from './three.module.js';
...
import { Uniform as Uniform46, UnsignedByteType as UnsignedByteType17 } from './three.module.js';
...
import { sRGBEncoding as sRGBEncoding16, Uniform as Uniform47, Vector2 as Vector226, Vector4 as Vector45, WebGLRenderTarget as WebGLRenderTarget22 } from './three.module.js';
...
import { LinearMipmapLinearFilter, Uniform as Uniform48, WebGLRenderTarget as WebGLRenderTarget23 } from './three.module.js';
...
import { Uniform as Uniform49 } from './three.module.js';
...
import { FileLoader, Loader, LoadingManager as LoadingManager3 } from './three.module.js';
...
import { FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager4, Vector3 as Vector37 } from './three.module.js';
...
import { Loader as Loader3, LoadingManager as LoadingManager5 } from './three.module.js';
