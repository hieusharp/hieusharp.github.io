...
/* 
	...
	particleTexture : textureLoader.load( 'images/star.png' ),
	...
	sizeBase   : 20.0,
	sizeSpread : 5.0,
	sizeTween  : new TWEEN.Tween( [0, 1], [1, 20] ),
			
	// colors stored in Vector3 in H,S,L format
	colorBase   : new THREE.Vector3(0.0, 1.0, 0.5),
	colorSpread : new THREE.Vector3(0,0,0),
	colorTween  : new TWEEN.Tween( [0.5, 2], [ new THREE.Vector3(0, 1, 0.5), new THREE.Vector3(1, 1, 0.5) ] ),

	opacityBase   : 1,
	opacitySpread : 0,
	opacityTween  : new TWEEN.Tween( [2, 3], [1, 0] ),
...
import { Type, ParticleEngine } from './ParticleEngine.js';
...
var Examples =
{
	...
	fountain :
	{
		...
		particleTexture : textureLoader.load( './assets/images/star.png' ),
		...
		sizeTween    : new TWEEN.Tween( [0, 1], [1, 20] ),
		opacityTween : new TWEEN.Tween( [2, 3], [1, 0] ),
		colorTween   : new TWEEN.Tween( [0.5, 2], [ new THREE.Vector3(0,1,0.5), new THREE.Vector3(0.8, 1, 0.5) ] ),
	...
	fireball :
	{
		...
		particleTexture : textureLoader.load( './assets/images/smokeparticle.png' ),

		sizeTween    : new TWEEN.Tween( [0, 0.1], [1, 150] ),
		opacityTween : new TWEEN.Tween( [0.7, 1], [1, 0] ),
	...
	smoke :
	{
		...
		sizeTween    : new TWEEN.Tween( [0, 1], [32, 128] ),
		opacityTween : new TWEEN.Tween( [0.8, 2], [0.5, 0] ),
		colorTween   : new TWEEN.Tween( [0.4, 1], [ new THREE.Vector3(0,0,0.2), new THREE.Vector3(0, 0, 0.5) ] ),
	...
	clouds :
	{
		...
		opacityTween : new TWEEN.Tween([0,1,4,5],[0,1,1,0]),
	...
	snow :
	{
		...
		particleTexture : textureLoader.load( './assets/images/snowflake.png' ),
			
		sizeTween    : new TWEEN.Tween( [0, 0.25], [1, 10] ),
		colorBase   : new THREE.Vector3(0.66, 1.0, 0.9), // H,S,L
		opacityTween : new TWEEN.Tween( [2, 3], [0.8, 0] ),
	...
	rain :
	{
		...
		particleTexture : textureLoader.load( './assets/images/raindrop2flip.png' ),
	...
	starfield :
	{
		...
		particleTexture : textureLoader.load( './assets/images/spikey.png' ),
	...
	fireflies :
	{
		...
		particleTexture : textureLoader.load( './assets/images/spark.png' ),

		sizeBase   : 30.0,
		sizeSpread : 2.0,
		opacityTween : new TWEEN.Tween([0.0, 1.0, 1.1, 2.0, 2.1, 3.0, 3.1, 4.0, 4.1, 5.0, 5.1, 6.0, 6.1],
	...
	firework :
	{
		...
		sizeTween    : new TWEEN.Tween( [0.5, 0.7, 1.3], [5, 40, 1] ),
		opacityTween : new TWEEN.Tween( [0.2, 0.7, 2.5], [0.75, 1, 0] ),
		colorTween   : new TWEEN.Tween( [0.4, 0.8, 1.0], [ new THREE.Vector3(0,1,1), new THREE.Vector3(0,1,0.6), new THREE.Vector3(0.8, 1, 0.6) ] ),
		blendStyle   : THREE.AdditiveBlending,  
    ...
    candle :
	{
		...
		sizeTween    : new TWEEN.Tween( [0, 0.3, 1.2], [20, 150, 1] ),
		opacityTween : new TWEEN.Tween( [0.9, 1.5], [1, 0] ),
		colorTween   : new TWEEN.Tween( [0.5, 1.0], [ new THREE.Vector3(0.02, 1, 0.5), new THREE.Vector3(0.05, 1, 0) ] ),
		blendStyle : THREE.AdditiveBlending,  
