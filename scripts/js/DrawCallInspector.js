...
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, d, k) {
...
$jscomp.polyfill = function(a, d, k, b) {
    if (d) {
        ...
        b = k[a] ;
        d = d(b);
        d != b && null != d && $jscomp.defineProperty(k, a, {
            configurable: !0,
            writable: !0,
            value: d
        })
...
$jscomp.polyfill("WeakMap", function(a) {
    function d(c) {
        $jscomp.owns(c, b) || $jscomp.defineProperty(c, b, {
            value: {}
        })
    }
...
(function() {
    ...
    function d(a, c, d, b) {
        ...
        this.fade = b.fade || .01;
        this.bias = b.bias || .25;
        this.scale = b.scale || .25;
        this.overlayStrength = b.overlayStrength || .5;
    ...
    var u = new THREE.OrthographicCamera(-1, 1, 1, -1, 0, 1),
        r = new THREE.Mesh(new THREE.PlaneBufferGeometry(2,
    ...
    d.prototype = {
        ...
        mount: function(c) {
            function d(a) {
                ...
                a.fragmentShader = a.fragmentShader.replace(/\}(?=[^.]*$)/g, "\n    float level = _uDelta * 3.14159265/2.;\n    vec3 heat;\n    heat.r = sin(level);\n    heat.g = sin(level * 2.5);\n    heat.b = cos(level * 2.0);\n\t\n\tgl_FragColor.rgb = mix( gl_FragColor.rgb, heat, " + h.overlayStrength.toFixed(1) + " );\n\t}\n")
            }
            ...
            if (!1 !== this.enabled) {
                ...
                var G = function() {
                        ...
                        return {
                            ...
                            push: function(b, f, g) {
                                ...
                                e || (e = f.uuid + "_" + g.uuid, void 0 === a[e] ? (b = g.clone(),
                                    g.uniforms && (b.uniforms = g.uniforms), b.onBeforeCompile = d, b.userData.material = g, b.userData.geometry = f, a[e] = b) : c.set(b, a[e]))
                            }
                        }
                    }(),
                    C, I = parseInt(THREE.REVISION),
                    y = {
                        material: null,
                        geometry: null,
                        group: null,
                ...
                if (this.enableGLHooks) {
                    ...
                    f.drawElements = function(a, c, b, d) {
                        if (w && v && 0 === h.recordMode) {
                            if (l) {
                                var e = f.createQuery();
                                e && (h.wait && h.pending++, v.userData.query = e, f.beginQuery(l.TIME_ELAPSED_EXT,
                                    e), E.call(this, a, c, b, d), f.endQuery(l.TIME_ELAPSED_EXT))
                            } else f.finish(), f.readPixels(0, 0, 1, 1, f.RGBA, f.UNSIGNED_BYTE, A), z = m.now(), E.call(this, a, c, b, d), f.finish(), f.readPixels(0, 0, 1, 1, f.RGBA, f.UNSIGNED_BYTE, A), v.userData.deltaTime = (m.now() - z) / 1E6, h.needsUpdate = !0;
                            w = 0
                    ...
                    f.drawElementsInstanced = function(a, c, b, d, g) {
                        if (w && v && 0 === h.recordMode) {
                            if (r) {
                                ...
                                f.readPixels(0, 0, 1, 1, f.RGBA, f.UNSIGNED_BYTE, A), z = m.now();
                            w = 0
                ...
                n.renderBufferDirect = function(a, c, b, d, g, t) {
                    if (1 === h.stage) {
                        ...
                        if (e.query) {
                            ...
                            if (1 === h.recordMode)
                                ...
                                } else f.finish(), f.readPixels(0, 0, 1, 1, f.RGBA, f.UNSIGNED_BYTE, A), z = m.now(), n.renderBufferDirect2(a, c, b, d, g, t),
                                    f.finish(), f.readPixels(0, 0, 1, 1, f.RGBA, f.UNSIGNED_BYTE, A), v.userData.deltaTime = (m.now() - z) / 1E6, h.needsUpdate = !0;
                    ...
                    else n.renderBufferDirect2(a,
                        c, b, d, g, t)
                };
                var B = this.container = document.createElement("div");
                B.innerHTML = '\n\t\t\t<input style="position: absolute; z-index: 2; right: 10px; top: 10px; opacity: 0.5; width: 5em;" type="number" min="-1" id="record" value="-1" />\n\t\t\t<div style="pointer-events: none; color: gray; display: flex; align-items: center; justify-content: center; position: absolute;left: 0;right: 0; top: 0; bottom: 0; font-size: 150%; font-family: Arial;">' + (this.timer ? "" : "< Click to Capture >") + '</div>\n\t\t\t<canvas style="position: relative; z-index: 1;"></canvas>\n\t\t\t';
        ...
        begin: function() {
            this.mounted &&
                (q.index = 0, this.stage = 1, !(this.wait && 0 < this.pending) && (this.renderFrame = this.renderer.info.render.frame, -1 < this.skipFrames && this.frameIndex++, this.needsRecord || this.frameIndex > this.skipFrames && -1 < this.skipFrames)) && (this.renderer.getSize(c), 0 < c.x && 0 < c.y && (this.needsRecord = !1, this.frameIndex = 0, this.recordCount++, c.set(c.x * this.scale, c.y * this.scale).floor(), c.x !== this.resolution.x || c.y !== this.resolution.y)) && (this.resolution.copy(c), this.target.setSize(c.x, c.y), this.domElement.width = c.x, this.domElement.height =
                    c.y)
        },
        end: function() {
            if (!1 !== this.enabled && this.needsUpdate) {
                ...
                if (q.index) {
                    ...
                    b -= this.maxDelta;
                    this.maxDelta += .05 * (b + Math.max(-b * this.bias, 0))
                }
                a.setRenderTarget(c);
                this.stage = 0
            }
